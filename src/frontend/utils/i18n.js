...
const translations = reactive({
  en: {
    ...
    showLongHistory: 'Show 2d / 4d / 7d history options',
    ...
    queryD1Quota: 'Query Account Daily D1 & Workers Quota',
  ...
  zh: {
    ...
    showBw: '显示带宽',
    showTf: '显示流量配额',
    showLongHistory: '显示 2天 / 4天 / 7天历史选项',
    ...
    queryD1Quota: '查询账户当日 D1 & Workers 用量',
    d1UsageDate: '统计日期',
    d1RowsRead: '已读取行数',
    d1RowsWritten: '已写入行数',
    d1NextReset: '下次重置',
